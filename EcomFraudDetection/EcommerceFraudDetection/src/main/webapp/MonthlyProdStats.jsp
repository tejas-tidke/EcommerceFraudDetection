...
<html>
    <head>
        ...
        <title>Monthly Products Statistics</title>
...
{     
    ...
    dt1=document.frm.cmbdt.value;
    //alert(id);
    http.open('get', 'GetProdPurchaseReport.jsp?cmbmon='+ id+'&cmbyr='+id1+'&cmbdt='+dt1);
...
<br/>
        ...
        <table align="center" class="tblform">
            <tr>
            <td>
                 <select name="cmbdt"   class="form-control" style="width:80px">
