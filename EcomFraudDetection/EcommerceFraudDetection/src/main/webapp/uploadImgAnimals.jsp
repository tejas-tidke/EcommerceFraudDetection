...
<div class="col-md-5"> <h2>Upload Animal Images</h2>
   <div class="form-group"> 
<form method="post" name="frm" action="RegAnimalImg" enctype="multipart/form-data">
<table class="tblform">
...
<c:forEach var="userdsc" items="${lst}">
	<option value="${userdsc.getAnimalId() }">    ${userdsc.getAnimalName() }</option>
