...
<div class="col-md-5"> <h2>Upload Hobbies Images</h2>
   <div class="form-group"> 
<form method="post" name="frm" action="RegHobbyImg" enctype="multipart/form-data">
<table class="tblform">
...
<td>Hobby  </td>
<td>
<select name="hobbyId" class="form-control" required>
<option value=""><--select--></option>
 
<c:forEach var="userdsc" items="${lst}">
	<option value="${userdsc.getHobbyId() }">    ${userdsc.getHobbyText() }</option>
